...
(function ($) {
    ...
    function render(opts) {
        ...
        if (title) {
            ...
            _img = '';
            if (dismissible) {
                _dismissable = '<button type="button" class="btn border-0 fs-5 fw-bold" data-bs-dismiss="toast" aria-label="Close" style="color: #fff">&times;</button>';
            }
            if (subtitle) {
            ...
            if (content) {
                ...
                if (dismissible) {
                    html += `<div class="d-flex">
                               ...
                               <button type="button" class="btn border-0 fs-5 fw-bold" data-bs-dismiss="toast" aria-label="Close" style="color: #fff">&times;</button>
                             </div>`;
                } else {
                    html += `<div class="toast-body">
                               ${content}
